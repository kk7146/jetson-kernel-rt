...
#undef NV_DRM_DISPLAY_DRM_HDCP_H_PRESENT
#undef NV_DRM_DISPLAY_DRM_HDCP_HELPER_H_PRESENT
...
#undef NV_DRM_DRM_FBDEV_GENERIC_H_PRESENT
...
#define NV_DT_BINDINGS_INTERCONNECT_TEGRA_ICC_ID_H_PRESENT
...
#define NV_RDMA_PEER_MEM_H_PRESENT
...
#define NV_LINUX_IOASID_H_PRESENT
